<template>
  <svg class="snow" preserveAspectRatio="none" width="1920" height="1080" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 1012 525">
    <defs/>
    <g fill="#fff" clip-path="url(#clip0)">
      ...
      <g id="snow3" fill-opacity=".8">
        ...
        <path id="Ellipse 220" d="M161.2 267.8a11.2 11.2 0 11-22.4 0 11.2 11.2 0 0122.4 0z"/>
  ...
  setup () {
    onMounted(() => {
      ...
      ScrollTrigger.create({
        ...
        scrub: 2,
        onEnter: () => {
          gsap.to('#snow1, #snow2, #snow3, #snow21, #snow22, #snow23', { display: 'block' })
          gsap.fromTo('#snow3', { yPercent: -110, repeat: -1, ease: 'none', duration: 10, delay: 2 }, { yPercent: 110, repeat: -1, ease: 'none', duration: 10, delay: 2 })
          gsap.fromTo('#snow2', { yPercent: -110, repeat: -1, ease: 'none', duration: 9, delay: 4 }, { yPercent: 110, repeat: -1, ease: 'none', duration: 9, delay: 4 })
          gsap.fromTo('#snow1', { yPercent: -110, repeat: -1, ease: 'none', duration: 7, delay: 4 }, { yPercent: 110, repeat: -1, ease: 'none', duration: 7, delay: 4 })
          gsap.fromTo('#snow23', { yPercent: -110, repeat: -1, ease: 'none', duration: 10, delay: 7 }, { yPercent: 110, repeat: -1, ease: 'none', duration: 10, delay: 7 })
          gsap.fromTo('#snow22', { yPercent: -110, repeat: -1, ease: 'none', duration: 9, delay: 7 }, { yPercent: 110, repeat: -1, ease: 'none', duration: 9, delay: 7 })
          gsap.fromTo('#snow21', { yPercent: -110, repeat: -1, ease: 'none', duration: 7, delay: 7 }, { yPercent: 110, repeat: -1, ease: 'none', duration: 7, delay: 7 })
        },
        onLeaveBack: () => {
          gsap.to('#snow1, #snow2, #snow3, #snow21, #snow22, #snow23', { display: 'none' })
        }
      })
    })
  }
...
<style scoped>
#snow1, #snow2, #snow3, #snow21, #snow22, #snow23 {
  display: none;
}
.snow {
  display: block;
